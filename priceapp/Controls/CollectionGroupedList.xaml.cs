...
public partial class CollectionGroupedList
{
    public CollectionGroupedList()
    {
        InitializeComponent();
    ...
    public static readonly BindableProperty ItemsSourceProperty =
        BindableProperty.Create(nameof(ItemsSource), typeof(ObservableCollection<ImageButtonsGroup>),
            typeof(CollectionGroupedList));

    public ObservableCollection<ImageButtonsGroup> ItemsSource
    {
        get => (ObservableCollection<ImageButtonsGroup>)GetValue(ItemsSourceProperty);
